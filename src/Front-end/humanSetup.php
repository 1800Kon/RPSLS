          ...
          <div class="ml-30 mr-30 w-auto text-center">
            <div class="px-5 py-6">
              ...
              <div class="relative inline-flex">
                ...
                <select name="playerCount" class="appearance-none border border-gray-300 rounded-md text-gray-600 h-10 pl-5 pr-5 bg-white md:pr-7 hover:border-gray-400 focus:outline-none ">
